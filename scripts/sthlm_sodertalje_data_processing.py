...
def cleanData241004(standardizeCoordinates=True):
    ...
    cleanData(fileName, dirRaw, dirClean, indicesToDrop, standardizeCoordinates)
...
def cleanData(fileName, dirRaw, dirClean, indicesToDrop, standardizeCoordinates=True):
